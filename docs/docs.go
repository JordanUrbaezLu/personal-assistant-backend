                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/models.CreateChatReq"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.ChatCreateResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SendMessageReq"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "Database or model error",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
